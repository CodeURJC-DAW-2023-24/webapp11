...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    @Query(value = "SELECT eru.registered_in_events_id, count(eru.registered_users_id) as re_count FROM eventcrafters.events_registered_users eru group by eru.registered_in_events_id order by re_count desc;",
            nativeQuery = true)
    List<Object[]> findByRegisteredUsersCount();
